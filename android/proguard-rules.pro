...
#-keep class var3d.net.center.DialogMessge{*;}
#-keep class var3d.net.center.StagePref{*;}
#-keep class var3d.net.center.StageLoad{*;}
#-keep class var3d.net.center.component.DialogLoad{*;}
#-keep class var3d.net.center.VPreferences{*;}
